...
Panache, melody, and depiction. Some troubadours have it all, but everyone starts somewhere. Your class act is your artform, the manner in which you go about unearthing the drama of everyday life and strife.

Choose one of the following class acts. Your choice determines your Act features and Act triggered action in addition to several features you get at later levels.
...
- **Virtuoso:** You find drama in music and song, weaving magic between the vibrations of your sound and filling the audience with your pathos. You wield an instrument. You gain the Music skill.
...
When you use an interpersonal skill on a test while interacting with an NPC like a bystander or a rival without failing, you can choose to form a bond with them. During negotiations with this NPC, their patience increases by 1 and compelling arguments you personally make to the NPC that would increase their interest by 1 instead increase their interest by 2. You can have a number of bonds active equal to your level, losing a bond of your choice whenever you make a new bond beyond your limit.
...
*Taps, kicks, steps. Now it's all âchoreography.â*
...
Your class act grants you features as shown on the 1st-level Class Act Features table.
...
**Effect:** While this routine is active, targets that start their turn within the aura can automatically get the tier-3 result on one test made to jump, tumble, or climb during their movement until the end of their turn.
...
*No, no, no, you lose the audience that way. Try it like this â¦*

**Effect:** At the end of each round, you can choose a number of creatures equal to your Presence score within the aura to be teleported to different, unoccupied squares within the aura. Targets can't be moved into places where they would immediately get hurt, such as over a cliffside or on a bed of spikes, nor can they be moved in a way that would result in them suffering a condition, such as grappled or restrained, or other harmful effect.
...
- **12-16:** shift 2; target can take a free strike with `â¡`
- **17+:** shift 3; target can take a free strike with `â¡` and spend 1 Recovery
...
Your `â¡` limit increases by 1, for a maximum of `â¡â¡â¡â¡`.
...
You can choose to invoke your reputation at the start of a social interaction with a community that hasn't met you before, automatically creating a bond with a representative NPC as if using your Scene Partner feature. While the bond is active, all present heroes are treated as having 2 higher Renown for the purposes of negotiations and influencing tests with the community.

The Director may choose to award the heroes with 1 Hero Token to stop you from forming this bond and make you infamous with the community instead. All present heroes have a bane on interpersonal skill tests with the community until actions are taken to improve your reputations. You can still use your Scene Partner feature to find allies within the community.
...
**Effect:** The targets shift up to 5 squares, including vertically. The targets must end this movement adjacent to each other and on solid ground. Each target can then take a free strike with `â¡â¡` against an enemy within reach.
...
**Effect:** If the target shifts or takes a free strike against you during this ability, you can shift 3 and take a melee free strike against the target. If the target deals damage to you during this ability, you have `â¡` on your free strike.
...
*Your fans don't seem to like the opening actâ¦*
...
If you aren't surprised at the beginning of an encounter, you can choose one non-boss or non-solo enemy within line of effect and have the director swap them out with a squad of minions that doesn't exceed the enemy's encounter value. This can't be used against an enemy directly associated with a special objective.

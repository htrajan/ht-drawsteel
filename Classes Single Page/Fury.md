...
You are never surprised. Additionally, whenever you would push a target with forced movement, you can slide them instead. As your rage grows, your primordial cunning intensifies.
...
- Once per turn, when you slide a target or move adjacent to a target during a shift, you can deal <code>⚡</code>.</td>
</tr>
<tr class="even">
<td>6</td>
<td>Once per turn, when you slide a target or move adjacent to a target during a shift, you can deal <code>⚡⚡</code>.</td>
</tr>
<tr class="odd">
<td>9</td>
...
<tr class="even">
<td>12 (Level 4)</td>
<td>Once per turn, when you slide a target or move adjacent to a target during a shift, you can deal weapon damage to the target equal to triple your Agility score.</td>
</tr>
<tr class="odd">
<td>15 (Level 7)</td>
...
<tr class="even">
<td>18 (Level 10)</td>
<td>- Once per turn, when you slide a target or move adjacent to a target during a shift, you can deal <code>⚡⚡⚡⚡</code>.<br />
...
Since most other classes get a bespoke maneuver, during playtesting many folks asked, “Where is the fury's special maneuver?” The fury doesn't need a maneuver all their own because most of the time we've found that the fantasy of the fury has them using the **Knockback** or **Grab** maneuvers in combat. They're really good at it too, so it doesn't make sense to give you another option that you'll rarely or never use.
...
- While in bear form, your attacks do <code>⚡</code>, and any target you have grabbed at the start of your turn takes <code>⚡</code>.</td>
</tr>
<tr class="even">
<td>6</td>
<td>While in bear form, your attacks do <code>⚡⚡</code>, and any target you have grabbed at the start of your turn takes <code>⚡⚡</code>.</td>
</tr>
<tr class="odd">
<td>9</td>
<td>You have a double edge on Might tests, resistance rolls, and power rolls made to grab.</td>
</tr>
<tr class="even">
<td>12 (Level 4)</td>
<td>While in bear form, your attacks do <code>⚡⚡⚡</code>, and any target you have grabbed at the start of your turn takes <code>⚡⚡⚡</code>.</td>
...
<tr class="even">
<td>15 (Level 7)</td>
<td>You always achieve Tier 3 results on Might tests, resistance rolls, and power rolls made to grab.</td>
</tr>
<tr class="odd">
<td>18 (Level 10)</td>
<td>- While in bear form, your attacks do <code>⚡⚡⚡⚡</code>, and any target you have grabbed at the start of your turn takes <code>⚡⚡⚡⚡</code>.<br />
...
- While in crow form, your attacks do <code>⚡</code>.<br />
- Once per turn while in crow form, when you move away from an enemy, that enemy takes damage equal to your Agility score.</td>
</tr>
<tr class="even">
<td>6</td>
<td>- While in crow or hybrid crow form, you can use all your abilities, and your attacks do <code>⚡⚡</code>.<br />
- Once per turn while in crow or hybrid crow form, when you move away from an enemy, that enemy takes <code>⚡⚡</code>.</td>
</tr>
<tr class="odd">
<td>9</td>
...
<td>18 (Level 10)</td>
<td>- While in crow or hybrid crow form, you can use all your abilities, and your attacks do <code>⚡⚡⚡⚡</code>.<br />
- Once per turn while in crow or hybrid crow form, when you move away from an enemy, that enemy takes <code>⚡⚡⚡⚡</code>.<br />
- Your size increases by 1 and you gain 20 Temporary Stamina the first time you grow to this size in the encounter.</td>
</tr>
</tbody>
</table>
...
When you are in your rat form, your movement gains the Climb keyword, you become the size of a rat, 1T. You can use the Hide maneuver as a free maneuver, and you can use your allies as cover when hiding. You can stay hidden while moving through squares occupied by a creature. Whenever your rage is 4 or higher, you can shapeshift to become a hybrid bipedal rat of your true form's size.
...
<td>3</td>
<td>- You gain an edge on Agility tests and resistance rolls.<br />
- While in wolf form, your attacks do <code>⚡</code>.<br />
- When you attack a target while in wolf form, the next ally to damage that target before the start of your next turn has <code>⚡</code> against the target.</td>
</tr>
<tr class="even">
<td>6</td>
<td>- While in wolf or hybrid wolf form, you can use all your abilities, and your attacks do <code>⚡⚡⚡</code>.<br />
- When you attack a target while in wolf or hybrid wolf form, the next ally to damage that target before the start of your next turn has <code>⚡⚡</code> against the target.</td>
</tr>
<tr class="odd">
<td>9</td>
<td>You have a double edge on Agility tests and resistance rolls.</td>
...
- When you attack a target while in wolf or hybrid wolf form, the next ally to damage that target before the start of your next turn has <code>🛡🛡🛡🛡</code> against the target.<br />
- Your size increases by 1 and you gain 20 Temporary Stamina the first time you grow to this size in the encounter.</td>
</tr>
</tbody>
</table>

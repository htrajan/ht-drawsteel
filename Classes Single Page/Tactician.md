...
**Effect:** Add or subtract `â¡` to the attack.
...
**Effect:** The attack's damage is reduced `ð¡ð¡`.
...
- **Speed Bonus:** +1
- **Ranged Weapon Damage Bonus:** +0/+0/+3
- **Distance Bonus:** +10
- **Disengage:** +1
- You also gain the use of the Protective Attack and Patient Shot signature abilities.

Kit signature abilities already have their bonuses applied. For example, you might take the Martial Artist kit, which gives a melee weapon damage bonus of +2/+2/+2, and the Mountain kit, which gives a melee weapon damage bonus of +0/+0/+3. If you choose to use the Mountain kit's damage bonus, then the Battle Grace signature ability from the Martial Artist kit would reduce its damage by -2/-2/-2, as it loses the bonus from the Martial Artist kit. It then gains the +0/+0/+3 of the Mountain kit, to deal damage of 2/5/10 for its tier 1, tier 2, and tier 3 results.
...
**Effect:** The target is marked by you until the start of your next turn. When attacking a marked target, you and each of your allies gain a damage surge `â¡`.
...
<tr class="odd">
<td>6</td>
<td>Attacks against the target do <code>â¡â¡</code> instead of <code>â¡</code>.</td>
</tr>
<tr class="even">
<td>8 (Level 4)</td>
...
<tr class="odd">
<td>10 (Level 7)</td>
<td>Attacks against the target do <code>â¡â¡â¡</code> instead of <code>â¡</code>.</td>
</tr>
<tr class="even">
<td>12 (Level 10)</td>
...
<tr class="odd">
<td>6</td>
<td>Allies have <code>ð¡</code> against attacks from the marked target.</td>
</tr>
<tr class="even">
<td>8 (Level 4)</td>
...
<tr class="odd">
<td>10 (Level 7)</td>
<td>Allies have <code>ð¡ð¡</code> against attacks from the marked target.</td>
</tr>
<tr class="even">
<td>12 (Level 10)</td>
...
- **11 or lower:** The target's next attack has `â¡`
- **12-16:** The target's next attack has `â¡`
- **17+:** The target's next attack has `â¡â¡`
...
âLet's not argue about who's the hammer and who's the anvil.â
...
At the beginning of your first turn, choose an offensive strategy or a defensive strategy. Your choice increases either your `â¡` limit to `â¡â¡â¡â¡` or your `ð¡` limit to `ð¡ð¡ð¡ð¡`.
...
You and your allies do `â¡` when attacking from concealment or while hidden.
...
âTry picking on someone MY size.â

**Effect:** You shift your speed directly toward an ally adjacent to the target and then swap locations with the ally, provided you can fit into each other's spaces. The ally can spend a Recovery and you roll power against the target.
...
**Effect:** Until the start of your next turn, targets have `ð¡ð¡` and a bonus to their Stability equal to your Might score.
...
**Effect:** Until the end of the encounter or you are dying, whenever you or an ally attacks a target marked by you, they do `â¡â¡`.
...
âWe can do this! Keep faith and hold fast!â

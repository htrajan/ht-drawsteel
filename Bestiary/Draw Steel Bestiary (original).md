...
**Cradle Heart**
On their turn, the mote can choose to die to revive a dead cradle crow, cradle horse, or cradle credenza within 1, returning with 8 Stamina.
...
Distance: Ranged 10
Target: Special
Effect: The ordinator summons 1 elemental mote for every 2 malice spent into unoccupied squares within distance.

**Conjure Cradle (Free Maneuver)** ◆ 2 Malice
Keywords: --
Distance: Ranged 10
Target: Special
Effect: The ordinator conjures 3 dead cradle crows, 1 dead cradle horse, or 1 dead cradle credenza into unoccupied squares within distance.
...
The Abyssal Wasteland is an alien landscape hostile to most life. Yet amidst its desolation, fiendish creatures thrive, including abyssal hyenas-bloodthirsty scavengers who fight with other lesser fiends over the corpses of demons. The first gnolls arose when a pack of these predators lapped at the ichor oozing from the wounds of a dying demon prince, As'sylrak the Warper.
...
The merciless gnolls quickly spread across the timescape in search of new victims to quench their never-ending hunger. Their packs were followed by some of the abyssal hyenas who didn't receive As'sylrak's blessing; these tagalongs enjoy the castoffs of the gnoll packs. Gnolls never forgot the day when they tasted immortal flesh-and they hunger for more, longing for a day when gnolls hunt the gods themselves through heavenly halls.
...
- **Bloodpool (5 Malice):** 1 minion gnoll suddenly melts into a pool of blood, splattering across each square within 3. A gnoll that starts their turn in a bloodpool has double edge on their next attack until the end of their turn. Once per round, an abyssal hyena that starts their turn in a bloodpool turns into a gnoll marauder, keeping their Stamina.
...
Distance: 2 burst
Target: All allies
Effect: 1 abyssal hyena target turns into a gnoll marauder, keeping their Stamina. Targets who haven't used a cackletongue maneuver on this turn use it immediately at no cost.
...
Distance: Ranged 10
Target: Special
Effect: The last laugh summons 5 gnoll wildlings and 5 abyssal hyenas into unoccupied spaces.
...
About forty days after hatching, a griffon chick learns to fly-and after that, it's only a matter of days before they set out from their nest into the wider world, generally making their own nest somewhere nearby.
...
At the start of a griffon's turn, you can spend malice to activate one of the following features:

- **Swoop (3 Malice):** A griffon acting this turn can take the following maneuver:
    **Swoop (Maneuver)**
    Keywords: --
    Distance: Self
    Target: Self
    Effect: The griffon flies up to their speed. The griffon takes a free strike against each creature that makes an opportunity attack against the griffon.

- **Piercing Cry (5 Malice):** A griffon acting this turn unleashes a hideous screech at an enemy within 5, forcing the creature to make an Intuition resistance roll:

- ✸ ≤11: Frightened of the griffon (save ends)

- ★ 12-16: Frightened of the griffon (EoT)
...
Target: Self
Effect: The griffon shifts up to their speed in a straight line. Each enemy within their reach during this movement can choose to either take 5 damage or be knocked prone.
...
Keywords: --
Trigger: The griffon flies above a creature on the ground within 10
Distance: Self
...
- ✸ 17+: 5 damage; A3 grabbed
    Effect: The griffon falls down upon the target, taking no damage from falling. A creature who is grabbed by the griffon is prone and can't stand until they are no longer grabbed.

**Beast of Prey**
Creatures have a double bane when using the Escape Grab maneuver to escape the griffon's grab.
